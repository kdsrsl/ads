...
public class DoubleclickInterstitialActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doubleclick_interstitial);
...
//        mInterstitialAd.setAdUnitId(getString(R.string.dfp_unit_id_insterstitily));
