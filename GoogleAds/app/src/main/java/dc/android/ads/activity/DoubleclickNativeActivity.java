...
public class DoubleclickNativeActivity extends BaseActivity {
//    private static final String DFP_AD_UNIT_ID = "/6499/example/native";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doubleclick_native);

        adUnitId = getString(R.string.dfp_unit_id_content);
    ...
    private void refreshAd(boolean requestAppInstallAds, boolean requestContentAds,
            ...
            builder.forAppInstallAd(new NativeAppInstallAd.OnAppInstallAdLoadedListener() {
                ...
                public void onAppInstallAdLoaded(NativeAppInstallAd ad) {
                    ...
                    NativeAppInstallAdView adView = (NativeAppInstallAdView) getLayoutInflater()
                            .inflate(R.layout.doubleclick_native_install, null);
            ...
            builder.forContentAd(new NativeContentAd.OnContentAdLoadedListener() {
                ...
                public void onContentAdLoaded(NativeContentAd ad) {
                    ...
                    NativeContentAdView adView = (NativeContentAdView) getLayoutInflater()
                            .inflate(R.layout.doubleclick_native_content, null);
            ...
            builder.forCustomTemplateAd(SIMPLE_TEMPLATE_ID,
                    new NativeCustomTemplateAd.OnCustomTemplateAdLoadedListener() {
                        ...
                        public void onCustomTemplateAdLoaded(NativeCustomTemplateAd ad) {
                            ...
                            View adView = getLayoutInflater()
                                    .inflate(R.layout.doubleclick_native_simple_template, null);
                    ...
                    new NativeCustomTemplateAd.OnCustomClickListener() {
                        ...
                        public void onCustomClick(NativeCustomTemplateAd ad, String s) {
                            Toast.makeText(DoubleclickNativeActivity.this,
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(DoubleclickNativeActivity.this, "Failed to load native ad: "
